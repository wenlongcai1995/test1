...
void LED_Init(void)
{
 ...
 RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOD|RCC_APB2Periph_GPIOC|RCC_APB2Periph_GPIOA, ENABLE);	 //使能PB,PE端口时钟
 ...
 GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5|GPIO_Pin_4;	    		 //LED1-->PE.5 端口配置, 推挽输出
